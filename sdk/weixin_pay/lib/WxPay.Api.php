...
class WxPayApi
{
	 ...
	 * @return 成功时返回，其他抛异常
	 */
	public static function unifiedOrder($inputObj, $timeOut = 6, $is_xcx = 0)
	{
		...
		self::reportCostTime($url, $startTimeStamp, $result, $is_xcx);//上报请求花费时间
	 ...
	 * @return 成功时返回，其他抛异常
	 */
	public static function orderQuery($inputObj, $timeOut = 6, $is_xcx = 0)
	{
	 ...
	 * @return 成功时返回，其他抛异常
	 */
	public static function report($inputObj, $timeOut = 1, $is_xcx = 0)
	{
	 ...
	 * @param array $data
	 */
	private static function reportCostTime($url, $startTimeStamp, $data, $is_xcx = 0)
	{
		//如果不需要上报数据
