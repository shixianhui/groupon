...
class Cases_model extends CI_Model {
	...
	public function gets($strWhere = NULL, $limit = NULL, $offset = NULL) {
		$ret = array();
		$this->db->select("{$this->_tableName}.id, {$this->_tableName}.title,  {$this->_tableName}.batch_path_ids, {$this->_tableName}.category_id, {$this->_tableName}.sort, {$this->_tableName}.title_color, {$this->_tableName}.path, {$this->_tableName}.abstract, {$this->_tableName}.hits, {$this->_menuTName}.html_path, {$this->_tableName}.add_time");
