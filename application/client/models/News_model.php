...
class News_model extends CI_Model {
	...
	public function gets($strWhere = NULL, $limit = NULL, $offset = NULL) {
		$ret = array();
		$this->db->select("{$this->_tableName}.id, {$this->_tableName}.title, {$this->_tableName}.sort, {$this->_tableName}.hits, {$this->_tableName}.abstract, {$this->_tableName}.hits, {$this->_tableName}.author, {$this->_tableName}.path, {$this->_tableName}.add_time, {$this->_tableName}.category_id, {$this->_menuTName}.menu_name, {$this->_menuTName}.html_path");
