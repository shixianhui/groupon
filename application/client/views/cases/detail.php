...
<?php foreach ($attachmentList as $key=>$value) { ?>
<li><a class="pic" bigimg="<?php echo $value['path']; ?>" smallimg="<?php echo preg_replace('/\./', '_max.', $value['path']); ?>"><img src="<?php echo preg_replace('/\./', '_thumb.', $value['path']); ?>" /></a></li>
<?php }} ?>
  </div>
    <!-- /content -->
