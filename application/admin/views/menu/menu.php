        ...
        <li class="open">
            ...
            <?php if (isPermissions($admingroupInfo, 'product_index')) { ?>
                ...
                <ul class="sub-menu">
                    <?php if (isPermissions($admingroupInfo, 'product_index')) { ?>
                        <li>
                            <a href="admincp.php/product/index/1" target="main-frame" onclick="add_class(this)">商品管理</a>
                        </li>
                    <?php } ?>
                    <?php if (isPermissions($admingroupInfo, 'groupon_index')) { ?>
                        <li>
                            <a href="admincp.php/groupon/index/1" target="main-frame" onclick="add_class(this)">活动管理</a>
                        </li>
                    <?php } ?>
<!--                    --><?php //if (isPermissions($admingroupInfo, 'groupon_index')) { ?>
                        <li>
                            <a href="admincp.php/light_img/index/1" target="main-frame" onclick="add_class(this)">点赞内容管理</a>
                        </li>
<!--                    --><?php //} ?>
                    <li>
                        <a href="admincp.php/enroll/index/1" target="main-frame" onclick="add_class(this)">点赞报名管理</a>
                    </li>
                    <li>
                        <a href="admincp.php/quote_price_record/index/1" target="main-frame" onclick="add_class(this)">报价列表</a>
                    </li>
                </ul>
            <?php } ?>
        </li>
        <li class="open">
            ...
            <?php if (isPermissions($admingroupInfo, 'orders_index')) { ?>
                ...
                <ul class="sub-menu">
                    <?php if (isPermissions($admingroupInfo, 'orders_index')) { ?>
                        <li>
                            <a href="admincp.php/orders/index/1" target="main-frame" onclick="add_class(this)">订单列表</a>
                        </li>
                    <?php } ?>
                    <?php if (isPermissions($admingroupInfo, 'groupon_record_index')) { ?>
                        <li>
                            <a href="admincp.php/groupon_record/index/1" target="main-frame" onclick="add_class(this)">拼团记录列表</a>
                        </li>
                    <?php } ?>
                    <?php if (isPermissions($admingroupInfo, 'exchange_index')) { ?>
                        <li>
                            <a href="admincp.php/exchange" target="main-frame" onclick="add_class(this)">退款申请管理</a>
                        </li>
                    <?php } ?>
                </ul>
            <?php } ?>
	 	...
	 	<li>
			 <!-- 会员管理开始 -->
			 <?php if (isPermissions($admingroupInfo, 'user_index') || isPermissions($admingroupInfo, 'usergroup_index')) { ?>
			 <a href="javascript:;" class="menu-title">
