...
style="cursor: pointer;" name="select_image" id="select_image" type="button" /> <input class="button_style" style="cursor: pointer;"  name="cut_image" id="cut_image" value="裁剪图片" type="button"  />
    ...
    <input class="button_style" name="batch_upload_image" id="batch_upload_image" value="批量添加" style="width: 60px;"  type="button" />  <input class="button_style" value="浏览..."
style="cursor: pointer;" name="batch_select_image" id="batch_select_image" type="button" />
    </td>
    </tr>
    <tr>
      <th width="20%">
      ...
      <td>
      <input name="url" id="url" size="50"  value="<?php if(! empty($itemInfo)){ echo $itemInfo['url'];} ?>"  maxlength="100" class="input_blur" type="text" />
      </td>
    </tr>
    <tr>
...
<script type="text/javascript">
    ...
    <td>
    <label><input class="checkbox_style" name="custom_attribute[]" id="h"  value="h" <?php if(! empty($itemInfo)){if(substr_count($itemInfo['custom_attribute'], "h")>0){echo "checked=true";}} ?> type="checkbox"/> 头条[h]</label>
	<label><input class="checkbox_style" name="custom_attribute[]" id="c"  value="c" <?php if(! empty($itemInfo)){if(substr_count($itemInfo['custom_attribute'], "c")>0){echo "checked=true";}} ?> type="checkbox"/> 推荐[c]</label>
  ...
  <br/>  <font color="red">注: ”幻灯“在首页头部显示，“滚动“在首页左下角显示,其它属性不起作用</font>
    </td>
    </tr>
    <tr>
