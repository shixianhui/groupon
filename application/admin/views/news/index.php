...
发布时间 <input class="input_blur" name="inputdate_start" id="inputdate_start" size="10" readonly="readonly" type="text">&nbsp;
...
<td><a href="admincp.php/<?php echo $template; ?>/save/<?php echo $value['id']; ?>" ><?php echo $value['title']; ?></a> <?php if($value['path']){ ?>[<font color="#FF0000">图片</font>]<?php } ?> </td>
...
<select class="input_blur" name="custom_attribute" id="custom_attribute" onchange="#">
<option value="">选择属性</option>
<option value="clear">去除属性</option>
<option value="h">头条[h]</option>
<option value="c">推荐[c]</option>
<option value="a">特荐[a]</option>
<option value="f">幻灯[f]</option>
<option value="s">滚动[s]</option>
<option value="b">加粗[b]</option>
</select>
</div>
<div id="pages">
<?php echo $pagination; ?>
