...
<td class="align_c">
    ...
    <?php echo $value['user_address']['txt_address'].$value['user_address']['address']; ?><br>
联系人：<?php echo $value['user_address']['buyer_name']; ?><br>
手机：<?php echo $value['user_address']['mobile']; ?><br>
            <?php } ?>
</td>
